...
contract colors {
    ...
    mapping (uint => string) messageLog;
    mapping (uint => address) senderLog;
    mapping (uint => string) senderColor;
    mapping (address => string) myColor;
    mapping (address => uint) colorCount;
    uint messageCount;
	...
	function setColorRed () external noColor {
	    red++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#ff383b";
	}
	
	function setColorOrange () external noColor {
	    orange++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#f8ac28";
	}
	
	function setColorYellow () external noColor {
	    yellow++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#ead353";
	}
	
	function setColorGreen () external noColor {
	    green++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#67d75c";
	}
	
	function setColorBlue () external noColor {
	    blue++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#476ef2";
	}
	
	function setColorTeal () external noColor {
	    teal++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#86e3db";
	}
	
	function setColorPurple () external noColor {
	    purple++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#9b5aea";
	}
	
	function setColorPink () external noColor {
	    pink++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#e96de8";
	}
	
	function setColorBlack () external noColor {
	    black++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#212121";
	}
	
	function setColorWhite () external noColor {
	    white++;
	    colorCount[msg.sender]++;
	...
	function changeColorRed () external hasColor {
	    red++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#ff383b";
	}
	
	function changeColorOrange () external hasColor {
	    orange++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#f8ac28";
	}
	
	function changeColorYellow () external hasColor {
	    yellow++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#ead353";
	}
	
	function changeColorGreen () external hasColor {
	    green++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#67d75c";
	}
	
	function changeColorBlue () external hasColor {
	    blue++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#476ef2";
	}
	
	function changeColorTeal () external hasColor {
	    teal++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#86e3db";
	}
	
	function changeColorPurple () external hasColor {
	    purple++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#9b5aea";
	}
	
	function changeColorPink () external hasColor {
	    pink++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#e96de8";
	}
	
	function changeColorBlack () external hasColor {
	    black++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#212121";
	}
	
	function changeColorWhite () external hasColor {
	    white++;
	    colorCount[msg.sender]++;
	    myColor[msg.sender] = "#cecece";
	}
